	...
	function com$yyuap$demo$WeiXinShareResultController$button1_onclick(sender, args) {
		...
		if ("friends" == type) {
			...
			/*$service.call("UMWXShare.init", {
				//"appid" : "wxaf6d93ddc1c3baff"//Android
				"appid" : "wx9a0d87487fd9bfa0"//IOS
			}, false);*/
			...
			$service.call("UMWXShare.sendTextandImage", {
				"url" : "http://mobile.yyuap.com/",
				"title" : "图文测试",
				"des" : "微信分享测试-好友",//$id("textarea0").get("value"),
				"image" : "app.png",//$id("image1").get("src"),
				"type" : "chat"
			}, false);
		}
	}
